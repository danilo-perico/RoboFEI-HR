...
/*
//***********************************************************************************
	if (variables.count("vb")) DECISION_ACTION_VISION = 0; // Detecta a Bola.				   //
	if (variables.count("vg")) DECISION_ACTION_VISION = 1; // Acha o Gol.				   //
	if (variables.count("vl")) DECISION_ACTION_VISION = 2; // Localiza Histograma igual ao armazenado.	   //
...
/*
	...
	{
*/
		CvScalar minB = cvScalar(0, 70, 130, 0);//4 160 //160
		CvScalar maxB = cvScalar(20, 255, 255, 0);//11 //250
	//}
...
//************************************************************************************************
        ...
        if (brightness < 20)
        {
	cout << "Esta escuro!! "<< brightness <<endl;
	//VISION_STATE = 1;
        }
        else
        {
        cout << "Esta Claro!! "<< brightness << endl;
	//VISION_STATE = 0;
        }
//************************************************************************************************
...
/*
		if (variables.count("tg") == 0)
		{
        		CvScalar minG = cvScalar(iLowHG, iLowSG, iLowVG,0);
        		CvScalar maxG = cvScalar(iHighHG, iHighSG, iHighVG,0);
		}
		else
		{
*/
...
*/
	...
	float RangeMin = 0.01;
	float RangeMax = 2;
	float sensibilidade = 20;


//O metodo "0" tem que ser próximo de zero
...
inicio = 0;
   ...
   //******************************************************************************************
	...
	TransitionGoal = 1;
        ...
        imshow("Histograma Salvo - 3 Canais", histImage );
     		if( (cvWaitKey(10) & 255) == 27)
      			break;
	usleep(3500);
        saveHistogramVectorToFile(b_hist, BlueFile);
