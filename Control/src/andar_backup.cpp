...
inclina_plano(LEG_RIGHT, 54, 40, 0); // inclina para direita
inclina_plano(LEG_LEFT, 56, 40, 0);  // inclina para direita
usleep(100000);
inverse_kinematic_right_leg(0, 0.008, 0, 500); // abaixa o corpo
...
espera_mov();
inclina_plano(LEG_RIGHT, 58, 45, 0); // inclina para direita
inclina_plano(LEG_LEFT, 62, 40, 0);
// Levanta pé curva de aceleração e desaceleração -----
inverse_kinematic_left_leg(0, ALTURA_PE, 0, 300); // levanta pé esquerdo
usleep(50000);
inverse_kinematic_left_leg(0, ALTURA_PE, 0, 500); // levanta pé esquerdo
usleep(50000);
...
usleep(35000);
inverse_kinematic_left_leg(LARGURA_PASSO, ALTURA_PE+.01, 7, 500); // avança pé esquerdo
usleep(55000);
inverse_kinematic_left_leg(LARGURA_PASSO, ALTURA_PE, 7, 200); // avança pé esquerdo
//espera_mov();
usleep(70000);
...
//espera_mov();
//---- abaixa pé --------------------------------------
inclina_plano(LEG_RIGHT, 45, 45, 5);
inclina_plano(LEG_LEFT, 60, 40, 10);
inverse_kinematic_right_leg(0, 0.008, 0, 80); // movimenta corpo pra frente
inverse_kinematic_left_leg(LARGURA_PASSO, 0.025, 5, 150); //abaixa pé esquerdo
usleep(30000);
inverse_kinematic_left_leg(LARGURA_PASSO, 0.025, 5, 300); //abaixa pé esquerdo
usleep(50000);
inverse_kinematic_left_leg(LARGURA_PASSO, 0.024, 5, 80); //abaixa pé esquerdo
//espera_mov();
usleep(40000);
...
inverse_kinematic_left_leg(MEIO_PASSO, 0.014, 0, 100);
inverse_kinematic_right_leg(-MEIO_PASSO, 0.008, 0, 100);
...
//usleep(100000);
espera_mov();
inclina_plano(LEG_RIGHT, -50, 30, -10); // inclina para esquerda
inclina_plano(LEG_LEFT, -43, 30, 0);  // inclina para esquerda
inverse_kinematic_left_leg(PASSO_1DE4, 0.008, 4, 100);
inverse_kinematic_right_leg(-PASSO_3DE4, 0.0095, -5, 100);
espera_mov();

inclina_plano(LEG_LEFT, -51, 40, 0);
inclina_plano(LEG_RIGHT, -58, 40, -10);
inverse_kinematic_left_leg(0, 0.01, 2, 100);

// curva de aceleração e desaceleração levantar pé--------
inverse_kinematic_right_leg(-LARGURA_PASSO, ALTURA_PE, -5, 300); //levanta pé direito
usleep(50000);
inverse_kinematic_right_leg(-LARGURA_PASSO, ALTURA_PE, -5, 500); //levanta pé direito
usleep(50000);
inverse_kinematic_right_leg(-LARGURA_PASSO+.02, ALTURA_PE, -5, 400); //levanta pé direito
//espera_mov();
...
//---- avança pé direito --------------------------------
inverse_kinematic_right_leg(LARGURA_PASSO, ALTURA_PE+.005, -5, 400); // avança o pé direito
usleep(35000);
inverse_kinematic_right_leg(LARGURA_PASSO, ALTURA_PE+.005, -5, 700); // avança o pé direito
usleep(35000);
inverse_kinematic_right_leg(LARGURA_PASSO, ALTURA_PE-0.005, -5, 500); // avança o pé direito
//espera_mov();
usleep(70000);
//-------------------------------------------------------
...
//-------------------------------------------------
usleep(60000);
inverse_kinematic_right_leg(MEIO_PASSO, 0.01, 0, 80);
inverse_kinematic_left_leg(-MEIO_PASSO, 0.008, 0, 80);

// volta da inclinação -------------------------------
inclina_plano(LEG_RIGHT, 0, 70, 0);//volta da inclinação ficando reto
inclina_plano(LEG_LEFT, 0, 70, 0); //volta da inclinação ficando reto
usleep(10000);
...
inclina_plano(LEG_LEFT, 46, 40, 0);  //inclina para direita
...
espera_mov();
inclina_plano(LEG_RIGHT, 55, 40, 0); //inclina para a direita
inclina_plano(LEG_LEFT, 60, 40, 10);
inverse_kinematic_left_leg(-PASSO_3DE4, 0.015, 0, 100);
// curva de aceleração e desaceleração levantar pé--------
...
inverse_kinematic_left_leg(0, ALTURA_PE, 0, 300);
espera_mov();
...
inclina_plano(LEG_RIGHT, 55, 45, 0); // inclina para direita
inclina_plano(LEG_LEFT, 55, 45, 0);  // inclina para direita
usleep(100000);
inverse_kinematic_right_leg(0, 0.008, 0, 500); // abaixa o corpo
inverse_kinematic_left_leg(0, 0.009, 0, 500); //abaixa o corpo
usleep(100000);
inverse_kinematic_right_leg(0, 0.008, 0, 200); // abaixa o corpo
inverse_kinematic_left_leg(0, 0.009, 0, 200); //abaixa o corpo
espera_mov();
inclina_plano(LEG_LEFT, 58, 40, 0);
// Levanta pé curva de aceleração e desaceleração -----
inverse_kinematic_left_leg(0, ALTURA_PE_v, 0, 300); // levanta pé esquerdo
usleep(50000);
inverse_kinematic_left_leg(0, ALTURA_PE_v, 0, 500); // levanta pé esquerdo
usleep(50000);
inverse_kinematic_left_leg(PASSO_1DE4_v, ALTURA_PE_v, 0, 300); // levanta pé esquerdo
//espera_mov();
usleep(65000);
//-------------------------------------------
...
{
// avança o pé esquerdo -------------------------------
inclina_plano(LEG_LEFT, 54, 30, 0);
inverse_kinematic_left_leg(PASSO_3DE4_v, ALTURA_PE_v, 0, 400); // avança pé esquerdo
usleep(35000);
inverse_kinematic_left_leg(LARGURA_PASSO_v, ALTURA_PE_v+.01, 7, 500); // avança pé esquerdo
usleep(55000);
inverse_kinematic_left_leg(LARGURA_PASSO_v, ALTURA_PE_v, 7, 200); // avança pé esquerdo
//espera_mov();
usleep(70000);
...
//---- abaixa pé --------------------------------------
inclina_plano(LEG_RIGHT, 45, 45, 5);
inclina_plano(LEG_LEFT, 45, 40, 10);
inverse_kinematic_right_leg(0, 0.008, 0, 80); // movimenta corpo pra frente
inverse_kinematic_left_leg(LARGURA_PASSO_v, 0.025, 5, 150); //abaixa pé esquerdo
usleep(30000);
inverse_kinematic_left_leg(LARGURA_PASSO_v, 0.025, 5, 300); //abaixa pé esquerdo
usleep(50000);
inverse_kinematic_left_leg(LARGURA_PASSO_v, 0.024, 5, 80); //abaixa pé esquerdo
//espera_mov();
usleep(40000);
//-----------------------------------------------------
inclina_plano(LEG_RIGHT, 45, 60, 0);
inclina_plano(LEG_LEFT, 45, 60, 0);
espera_mov();
//usleep(70000);
inverse_kinematic_left_leg(MEIO_PASSO_v, 0.01, 0, 100);
inverse_kinematic_right_leg(-MEIO_PASSO_v, 0.008, 0, 100);
...
inclina_plano(LEG_LEFT, 0, 150, 0);  // volta da inclinação ficando reto
usleep(45000);
inclina_plano(LEG_RIGHT, 0, 50, 0); // volta da inclinação ficando reto
inclina_plano(LEG_LEFT, 0, 50, 0);  // volta da inclinação ficando reto
espera_mov();
...
inverse_kinematic_left_leg(PASSO_1DE4_v, 0.008, 5, 100);
inverse_kinematic_right_leg(-PASSO_3DE4_v, 0.013, -8, 200);
espera_mov();
...
usleep(50000);
inverse_kinematic_right_leg(-LARGURA_PASSO_v, ALTURA_PE_v, -7, 500); //levanta pé direito
usleep(50000);
inverse_kinematic_right_leg(-LARGURA_PASSO_v+.02, ALTURA_PE_v+.005, -7, 400); //levanta pé direito
//espera_mov();
usleep(60000);
//--------------------------------------------------------
inverse_kinematic_left_leg(0, 0.008, 2, 100); // volta com o corpo um pouco pra frente
...
//---- avança pé direito --------------------------------
inverse_kinematic_right_leg(LARGURA_PASSO_v, ALTURA_PE_v+.005, -5, 400); // avança o pé direito
usleep(35000);
...
espera_mov();
//----------------------------------------------------
inclina_plano(LEG_RIGHT, 46, 40, 0); //inclina para a direita
inclina_plano(LEG_LEFT, 46, 40, 0);  //inclina para direita
inverse_kinematic_right_leg(PASSO_1DE4_v, 0.008, 0, 200); // abaixa o corpo
inverse_kinematic_left_leg(-PASSO_3DE4_v, 0.009, 0, 200); //abaixa o corpo
espera_mov();

inclina_plano(LEG_LEFT, 50, 40, 10);
inverse_kinematic_right_leg(0, 0.008, 0, 100);
// curva de aceleração e desaceleração levantar pé--------
